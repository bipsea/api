...
export default async function handler(req, res) {
  try {
    ...
    const values = [metadata.itemId, metadata.title, metadata.description, metadata.imageUri, metadata.chain, metadata.price, metadata.seller, metadata.filename, metadata.encryptedFileUri, metadata.encryptedSymmetricKey, metadata.onchain, false];
